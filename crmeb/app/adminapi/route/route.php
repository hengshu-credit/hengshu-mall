...
Route::group(function () {
    //升级程序
    Route::get('upgrade', 'UpgradeController/index')->middleware([\app\adminapi\middleware\AdminAuthTokenMiddleware::class,\app\adminapi\middleware\AdminCheckRoleMiddleware::class]);
    Route::get('upgrade/run', 'UpgradeController/upgrade')->middleware([\app\adminapi\middleware\AdminAuthTokenMiddleware::class,\app\adminapi\middleware\AdminCheckRoleMiddleware::class]);
    //用户名密码登录
